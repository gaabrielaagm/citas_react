...
const Formulario = ({ pacientes, setPacientes, paciente, setPaciente }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (paciente.id) {
      // editando paciente
      // paciente = el objeto que se le dio click en 'Editar
      // objPaciente = el objeto con la información actualizada/modificada
      ...
      // reseteamos variable desde App component
      setPaciente({});
    } else {
