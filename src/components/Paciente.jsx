const Paciente = ({paciente, setPaciente, eliminarPaciente}) => {
  ...
  const {nombre: nom, propietario: prop, email, fecha, sintomas, id } = paciente;
  ...
  return (
    <div className="mx-5 my-6 bg-white shadow-md px-5 py-10 rounded-xl">
        ...
        <span className="font-normal normal-case">{nom}</span>
        </p>
        ...
        <div className="flex justify-end">
          <button
            type="button"
            className="py-2 px-10 mx-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold uppercase rounded"
